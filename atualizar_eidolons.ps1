...
function Build-PageHtml {
    ...
    [void]$sb.AppendLine("            <div class='class-guide-item'>Duelist</div>")
    [void]$sb.AppendLine("            <div class='class-guide-item'>Guardian</div>")
    [void]$sb.AppendLine("            <div class='class-guide-item'>Ravager</div>")
    [void]$sb.AppendLine("            <div class='class-guide-item'>Wizard</div>")
    [void]$sb.AppendLine("            <div class='class-guide-item'>Gunslinger</div>")
    [void]$sb.AppendLine("            <div class='class-guide-item'>Grenadier</div>")
    [void]$sb.AppendLine("            <div class='class-guide-item'>Sorcerer</div>")
    [void]$sb.AppendLine("            <div class='class-guide-item'>Bard</div>")
    [void]$sb.AppendLine("            <div class='class-guide-item'>Brawler</div>")
    [void]$sb.AppendLine("            <div class='class-guide-item'>Ranger</div>")
    [void]$sb.AppendLine("            <div class='class-guide-item'>Ronin</div>")
    [void]$sb.AppendLine("            <div class='class-guide-item'>Reaper</div>")
    [void]$sb.AppendLine("            <div class='class-guide-item'>Holy Sword</div>")
    [void]$sb.AppendLine("            <div class='class-guide-item'>Shinobi</div>")
    [void]$sb.AppendLine("            <div class='class-guide-item'>Lancer</div>")
    [void]$sb.AppendLine("            <div class='class-guide-item'>Guitar</div>")
    [void]$sb.AppendLine("            <div class='class-guide-item'>Star Caller</div>")
    [void]$sb.AppendLine("            <div class='class-guide-item'>Whipmaster</div>")
    [void]$sb.AppendLine("            <div class='class-guide-item'>Dragon Nunchaku</div>")
    [void]$sb.AppendLine("            <div class='class-guide-item'>Stellar Sphere</div>")
    [void]$sb.AppendLine("          </div>")
    [void]$sb.AppendLine("        </details>")
    ...
    [void]$sb.AppendLine("        <ul class=`"gear-guide-list`">")
    [void]$sb.AppendLine("          <li><strong>Below Lv95:</strong> Use reward weapons from Aura and Advanced Gaia (one from Lv1-40 and one from Lv40-75). They can carry you comfortably until Lv95.</li>")
    ...
    [void]$sb.AppendLine("          <li><strong>S5:</strong> If you still do not have a Lv95 option, craft your Abyss II element weapon or use an S5 gold weapon with your element.</li>")
    [void]$sb.AppendLine("          <li><strong>S10:</strong> The Lv95 Abyss II weapon is still good here. If you really want to change, craft the S10 orange weapon.</li>")
