...
function Build-PageHtml {
    ...
    [void]$sb.AppendLine("    .info-menu-panel .lucky-pack-btn, .info-menu-panel .wish-coin-btn, .info-menu-panel .limit-break-btn, .info-menu-panel .dungeon-guide-btn, .info-menu-panel .leveling-guide-btn, .info-menu-panel .boost-guide-btn { width:100%; justify-content:flex-start; }")
