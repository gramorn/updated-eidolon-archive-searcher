...
function Build-PageHtml {
    ...
    [void]$sb.AppendLine("        <button id=`"themeToggle`" class=`"theme-toggle`" type=`"button`" aria-label=`"Switch to light theme`" title=`"Switch to light theme`"><span id=`"themeIcon`" class=`"theme-icon`">&#x2600;&#xFE0F;</span></button>")
    [void]$sb.AppendLine("      </div>")
    [void]$sb.AppendLine("    </div>")
    ...
    [void]$sb.AppendLine("      themeIcon.textContent = (t === 'dark') ? '☀️' : '🌙';")
